...
class _$CharacterDao extends CharacterDao {
    ...
    this.changeListener,
        ...
        _characterInsertionAdapter = InsertionAdapter(
            ...
            (Character item) => <String, Object?>{
                  ...
                  'attributeEnabled': item.attributeEnabled,
  ...
  Future<List<Character>> findAllCharacters() async {
    return _queryAdapter.queryList('SELECT * FROM Character',
        mapper: (Map<String, Object?> row) => Character(
            ...
            attributeEnabled: row['attributeEnabled'] as int,
  ...
  @override
  Future<Character?> findCharacter() async {
    return _queryAdapter.query('SELECT * FROM Character LIMIT 1',
        mapper: (Map<String, Object?> row) => Character.fromMap(row),
        arguments: []);
  }
